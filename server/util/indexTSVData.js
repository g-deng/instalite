 ...
 */
export async function indexTSVData(filePath, collectionName = "indexedData", max=10) {
  ...
  for (const record of records) {
    ...
    try {
      ...
      await chroma.put_item_into_table_chatbot(collectionName, id, content, embedding, metadata );
...
export async function createPostsTSV() {
